...
type HNM struct {
	...
	WindowCount          int
	WarnBeforeWindow     time.Duration
	CutoffAfterWindow    time.Duration
	UseHourlyWarningFlow bool
	KeepCampOpenUntilPop bool
	HQName               string
	Emoji                string
	Info                 string
	Note                 string
